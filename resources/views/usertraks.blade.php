            ...
            <div class="row justify-content-center">
              @foreach ($traks as $trak)
                <div class="col-md-3 col-sm-0"></div>
                  <div class="col-md-6 col-sm-12 underlaine">
                    <a class="nav-link text-center" href="/traks/{{$trak->id}}" {{ $trak->pavadinimas }} sukurtas {{ $trak->created_at}} <br />
                    ...
                    <a class="nav-link text-center" href="/edit/{{ $trak->id }}">redaguoti darbo įrašą</a> <br />
                    <a class="nav-link text-center" href="/delete/{{ $trak->id }}">ištrinti darbo įrašą</a> <br />
                  </div>
                <div class="col-md-3 col-sm-0"></div>
              @endforeach
            </div>
